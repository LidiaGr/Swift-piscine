...
class PlacesAPI {
    private static var allPlaces = [
        Place(title: "School 21 Kazan", coordinate: CLLocationCoordinate2D(latitude: 55.78202336617276, longitude: 49.125136555061616) , info: "My favorite School", color: .red),
